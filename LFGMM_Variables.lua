...
classEnglish, classLocalized = LFGMM_Utility_GetPlayerClass();
...
LFGMM_GLOBAL = {
	...
	PLAYER_CLASS = classEnglish,
	PLAYER_CLASS_LOCALIZED = classLocalized,
	...
	DUNGEONS = {
		...
		},
		{
			...
			Identifiers = {
				...
				"quest[s]?[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				...
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*quest[s]?",
		...
		},
		{
			...
			Identifiers = {
				...
				"at[t]?un[e]?ment[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				...
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*at[t]?un[e]?ment",
		...
		},
		{
			...
			Identifiers = {
				"black[%W]*rock[%W]*dep[t]?[h]?s[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"brd[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*run[s]?",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*quest[s]?",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*at[t]?un[e]?ment",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*arena",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*prison",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*vault",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*lava",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*emp[r]?eror",
				"anger[f]?[o]?[r]?[g]?[e]?[%W]*[o]?[r]?[%W]*princes[s]?",
				"quest[s]?[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"at[t]?un[e]?ment[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"arena[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"prison[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"vault[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"lava[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"emp[r]?eror[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
				"princes[s]?[%W]*[o]?[r]?[%W]*anger[f]?[o]?[r]?[g]?[e]?",
			},
			ParentDungeon = 22,
			Size = 5,
			MinLevel = 52,
